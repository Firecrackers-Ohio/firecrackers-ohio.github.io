...
const $$Teams = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent(
      ...
      {
        default:
          $$result2 => renderTemplate` ${maybeRenderHead()}<div class="font-poppins min-h-screen flex items-center justify-center"> <div class="text-center"> <h1 class="text-6xl md:text-8xl font-bold text-gray-800 mb-4 tracking-tight">
Coming Soon!
