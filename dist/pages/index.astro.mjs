...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="min-h-screen"> <div class="container mx-auto px-4 py-8"> <!-- Header --> <div class="mb-12 text-center"> <img src="/logo-text-outline.svg" alt="FIRECRACKERS" class="h-24 mx-auto filter brightness-50 dark:brightness-80 dark:invert"> <h2 class="text-4xl font-bold text-gray-900 dark:text-gray-400 font-almarai">TRYOUTS</h2> <p class="py-6 text-lg text-gray-700 dark:text-gray-300 mt-2">All tryouts will be held at Lou Beriner Sports Park. Players are encouraged to attend both dates. See below for age group details. Please reach out to the team coach with any questions.</p> <a href="https://docs.google.com/forms/d/e/1FAIpQLSd3Xiv5M5WycU9bQDIubCt_eAFehdVMxJ-IRgg3rR7nxvEIgw/viewform" target="_blank" rel="noopener noreferrer" class="inline-block mt-4 px-6 py-3 bg-red text-white font-bold rounded-lg transition-colors">
